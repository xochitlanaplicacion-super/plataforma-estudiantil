-- Amplía el historial consultable de KIBO para recuperar o corregir una
-- actividad antigua del mismo criterio durante todo el periodo activo.
...
comment on function public.obtener_conceptos_recientes_docente_movil(uuid, uuid, uuid) is
  'Hasta 200 conceptos del periodo activo para buscar, recuperar o corregir notas con cobertura por alumno.';
