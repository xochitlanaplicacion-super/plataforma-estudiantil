      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-20">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
            <a href="#oferta-educativa" className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg text-center transition-all duration-300 shadow-lg shadow-blue-500/30 flex justify-center items-center gap-2 uppercase tracking-wide">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/images/about.jpg" alt="Aula moderna en México" className="w-full h-auto object-cover" />
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
          ...
          >
            ...
            <div className="p-8">
              ...
              <a href="#contacto" className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl transition-colors duration-300 uppercase tracking-widest text-sm shadow-md">
                Inscríbete
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="p-8">
              ...
              <a href="#contacto" className="block w-full text-center bg-[#0A2647] hover:bg-blue-900 text-white font-bold py-4 rounded-xl transition-colors duration-300 uppercase tracking-widest text-sm shadow-md">
                Inscríbete
              </a>
            </div>
          </motion.div>
  ...
  return (
    <div className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <img src="/images/graduation.jpg" alt="Estudiantes graduándose" className="w-full h-full object-cover" />
      </div>
      <div className="relative z-20 text-center px-4">
        ...
        >
          ...
          <a href="#contacto" className="inline-block bg-white text-[#0A2647] px-8 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-blue-50 transition-colors shadow-xl">
            Únete a ellos
          </a>
        </motion.div>
      </div>
